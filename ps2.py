...
import os
os.chdir("C:\\Users\\Nancy Zhao\\Desktop\\Python\\edx6.00.2\\pset2")
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.room.cleanTileAtPosition(self.position) #The robot cleans the tile it is on.
        #raise NotImplementedError
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        NextPosition = CurrentPosition.getNewPosition(angle, speed)
...
class RandomWalkRobot(Robot):
    ...
    choosedef updatePositionAndClean(self)s a new direction at random at the end of each time-step.
    """
    """
        Simulate the passage of a single time-step.
    ...
    def updatePositionAndClean(self):    
        ...
        speed = self.speed
        CurrentPosition = self.getRobotPosition()
        NextPosition = CurrentPosition.getNewPosition(rand_angle, speed)
        if self.room.isPositionInRoom(NextPosition) == False:
            self.setRobotDirection (random.randint(0, 359)) 
        else:
            self.setRobotPosition(NextPosition)
